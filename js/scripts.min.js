...
var map;function init(){var e={center:new google.maps.LatLng(50.4602328,30.5208395),zoom:16,zoomControl:!0,zoomControlOptions:{style:google.maps.ZoomControlStyle.DEFAULT},disableDoubleClickZoom:!0,mapTypeControl:!1,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.HORIZONTAL_BAR},scaleControl:!0,scrollwheel:!1,panControl:!0,streetViewControl:!1,draggable:!0,overviewMapControl:!1,overviewMapControlOptions:{opened:!1},mapTypeId:google.maps.MapTypeId.ROADMAP,styles:[{featureType:"administrative",elementType:"labels",stylers:[{visibility:"simplified"}]},{featureType:"administrative.country",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"administrative.province",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"administrative.locality",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"simplified"}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"off"}]}]},a=document.getElementById("map"),t=new google.maps.Map(a,e),o=[["Київ","undefined","undefined","undefined","undefined",50.4602328,30.5208395,"https://mapbuildr.com/assets/img/markers/default.png"]];for(i=0;i<o.length;i++)"undefined"==o[i][1]?description="":description=o[i][1],"undefined"==o[i][2]?telephone="":telephone=o[i][2],"undefined"==o[i][3]?email="":email=o[i][3],"undefined"==o[i][4]?web="":web=o[i][4],"undefined"==o[i][7]?markericon="":markericon=o[i][7],marker=new google.maps.Marker({icon:"./images/ico-marker-2.jpg",position:new google.maps.LatLng(o[i][5],o[i][6]),map:t,title:o[i][0],desc:description,tel:telephone,email:email,web:web}),link=""}$(document).ready(function(){$("body").addClass("main"),$(function(){$(".lazy").lazy()}),$(".text_slider").slick({dots:!0,infinite:!0,fade:!0,speed:2e3,arrows:!0,autoplay:!0,cssEase:"ease-in-out",pauseOnFocus:!1,pauseOnHover:!1,lazyLoad:"ondemand"}),$(".text_slider_2").slick({dots:!0,infinite:!0,fade:!0,arrows:!0,autoplay:!1,cssEase:"linear",pauseOnFocus:!1,pauseOnHover:!1,lazyLoad:"ondemand"}),$(".text_slider_3").slick({dots:!0,infinite:!0,fade:!1,arrows:!0,adaptiveHeight:!0,autoplay:!1,cssEase:"linear",slidesToShow:2,slidesToScroll:1,lazyLoad:"ondemand",responsive:[{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1,adaptiveHeight:!0,fade:!0}}]}),$(".text_slider_4").slick({dots:!0,infinite:!0,fade:!0,arrows:!0,autoplay:!1,cssEase:"linear",slidesToShow:1,slidesToScroll:1,lazyLoad:"ondemand"}),$(".text_slider_5").slick({dots:!1,infinite:!0,fade:!1,arrows:!1,autoplay:!1,cssEase:"linear",slidesToShow:1,slidesToScroll:1,lazyLoad:"ondemand",responsive:[{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,adaptiveHeight:!1,fade:!0,dots:!0,arrows:!0}}]}),$(".text_slider_6").slick({dots:!1,infinite:!0,fade:!1,arrows:!1,autoplay:!1,cssEase:"linear",lazyLoad:"ondemand",slidesToShow:8,slidesToScroll:1,responsive:[{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,adaptiveHeight:!1,fade:!0,dots:!0,arrows:!0}}]}),$(".text_slider_map").slick({dots:!0,infinite:!0,fade:!0,arrows:!0,autoplay:!1,cssEase:"linear",slidesToShow:1,slidesToScroll:1,lazyLoad:"ondemand"}),$(".text_slider_city").slick({dots:!1,infinite:!0,fade:!0,arrows:!0,autoplay:!1,cssEase:"linear",slidesToShow:1,slidesToScroll:1,lazyLoad:"ondemand"}),$(".text_slider_europe").slick({dots:!1,infinite:!0,fade:!0,arrows:!0,autoplay:!1,cssEase:"linear",slidesToShow:1,slidesToScroll:1,lazyLoad:"ondemand"}),$("#menu_button").on("click",function(e){e.preventDefault(),$("body").toggleClass("no-scroll"),$(".modal_menu").toggleClass("show_menu"),$("#menu_button").toggleClass("effect_close")}),$(".mob_push").on("click",function(e){e.preventDefault(),$("body").toggleClass("no-scroll")}),$(document).ready(function(){var t=$("#tabs");$(".tabs-content > div",t).each(function(e){0!=e&&$(this).hide(0)}),t.on("click",".tabs a",function(e){e.preventDefault();var a=$(this).attr("href");$(".tabs a",t).removeClass(),$(this).addClass("active"),$(".tabs-content > div",t).hide(0),$(a).show()})}),$(document).ready(function(){var t=$("#tabs_2");$(".tabs-content > div",t).each(function(e){0!=e&&$(this).hide(0)}),t.on("click",".tabs a",function(e){e.preventDefault();var a=$(this).attr("href");$(".tabs a",t).removeClass(),$(this).addClass("active"),$(".tabs-content > div",t).hide(0),$(a).show()})}),$(document).ready(function(){var t=$("#tabs_3");$(".tabs-content-3 > div",t).each(function(e){0!=e&&$(this).hide(0)}),t.on("click",".tabs a",function(e){e.preventDefault();var a=$(this).attr("href");$(".tabs a",t).removeClass(),$(this).addClass("active"),$(".tabs-content-3 > div",t).hide(0),$(a).show()})}),$(".open-popup-link").magnificPopup({type:"inline",midClick:!0,mainClass:"mfp-fade"}),$(".mobile_ul").mPageScroll2id(),$(function(){(new WOW).init({mobile:!1}),new WOW({boxClass:"counter",animateClass:"animated",offset:0,mobile:!1,live:!0,callback:function(){$("#amount-count").numerator({easing:"linear",duration:2e3,toValue:25}),$("#amount-count-2").numerator({easing:"linear",duration:2e3,toValue:250}),$("#amount-count-3").numerator({easing:"linear",duration:2e3,toValue:4200}),$("#amount-count-4").numerator({easing:"linear",duration:2e3,toValue:5e3}),$("#amount-count-5").numerator({easing:"linear",duration:2e3,toValue:100}),$("#amount-count-6").numerator({easing:"linear",duration:2e3,toValue:260}),$("#amount-count-7").numerator({easing:"linear",duration:2e3,toValue:8}),$("#amount-count-8").numerator({easing:"linear",duration:2e3,toValue:9001}),$("#amount-count-9").numerator({easing:"linear",duration:2e3,toValue:2015})}}).init()}),$.get("http://ipinfo.io",function(e){$("[name=city]").val(e.city+", "+e.country)},"jsonp"),$("[name=city]").val(void 0),$(function(){$("[name=send]").click(function(){var e,a=$(this),i=$(this).closest("form");$(":input.error").removeClass("error"),$(".allert").remove();var t=a.closest("form").find("[required]"),o=$('[name="name"]').val();$("[name=name]").val(o);var n=a.closest("form").find("input, textarea, select"),s=(a.closest("form").find('[name=project_name], [name=admin_email], [name=form_subject], [name=city], [name=page_url], [name=user_agent], [type="text"], [type="email"], [type="tel"]'),a.closest("form").find("[name=send]")),l=(a.closest("form").find("[name=send_adress]").val(),a.closest("form").find("[name=campaign_token]"));a.closest("form").find("[name=form_type]").val(),a.closest("form").find("[name=redirect]").val(),a.closest("form").find("[name=goal]").val();return $(t).each(function(){if(""==$(this).val()){$(this);return $(this).addClass("error").parent(".field").append('<div class="allert"><span>Заполните это поле</span><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></div>'),e=1,void $(":input.error:first").focus()}"email"==$(this).attr("type")&&(/^([a-z0-9_\.-])+@[a-z0-9-]+\.([a-z]{2,4}\.)?[a-z]{2,4}$/i.test($(this).val())||($("[name=email]").val(""),$(this).addClass("error").parent(".field").append('<div class="allert"><span>Укажите коректный e-mail</span><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></div>'),e=1,$(":input.error:first").focus()));"tel"==$(this).attr("type")&&(/^([0-9_()+\.-]{2,4})/i.test($(this).val())||($("[name=phone]").val(""),$(this).addClass("error").parent(".field").append('<div class="allert"><span>Укажите коректный номер телефона</span><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></div>'),e=1,$(":input.error:first").focus()))}),1!=e&&($(s).each(function(){$(this).attr("disabled",!0)}),$(l).each(function(){var e=$(this).closest("form").serializeArray(),t={};$.each(e,function(e,a){t[a.name]=a.value}),console.log(t),$.urlParam=function(e){var a=new RegExp("[?&]"+e+"=([^&#]*)").exec(window.location.href);if(a)return a[1]},""==$(this).val()?$.ajax({type:"POST",url:"mail.php",data:n,success:function(){$.ajax({type:"POST",url:"db/registration.php",dataType:"json",data:i.serialize(),success:function(e){console.info(e),console.log(i.serialize()),"success"==e.status&&($("form").trigger("reset"),setTimeout(function(){$("[name=send]").removeAttr("disabled")},2e3),window.location.href="http://campeao.pro/service/success.html")}})},error:function(e,a){alert("Возникла ошибка: "+e.responseCode)}}):$.ajax({type:"POST",url:"mail.php",data:n,success:$.ajax({type:"POST",url:"https://app.getresponse.com/add_subscriber.html",data:n,statusCode:{0:function(){setTimeout(function(){$("[name=send]").removeAttr("disabled")},2e3),window.location.href="http://campeao.pro/service/success.html"}}}),error:function(e,a){alert("Возникла ошибка: "+e.responseCode)}})})),!1})})}),google.maps.event.addDomListener(window,"load",init);